...
//
// $Id: C_timer_with_reset.c 29570 2012-04-19 04:34:13Z karl $
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
...
int main()
{
  ...
  double Boo_expected = Boo_Sleep*Max_Iters/1.e6;
  double Bar_expected = Bar_Sleep*Max_Iters/1.e6;
  double Foo_expected = Foo_Sleep*Max_Iters/1.e6;
