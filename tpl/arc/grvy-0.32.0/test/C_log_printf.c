...
//
// $Id: C_log_printf.c 26801 2012-01-09 12:53:43Z karl $
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
...
void post_log_messages()
{
  grvy_printf(GRVY_FATAL,"a fine fatal message    (%i)\n",42 );
  grvy_printf(GRVY_ERROR,"an astute error message (%f)\n",42.0);
  grvy_printf(GRVY_WARN, "a fabulous warn message (%03i)\n",42);
  grvy_printf(GRVY_INFO, "a useful info message   (%s)\n","tori");
  grvy_printf(GRVY_DEBUG,"a clever debug message  (%e)\n",42.0);
